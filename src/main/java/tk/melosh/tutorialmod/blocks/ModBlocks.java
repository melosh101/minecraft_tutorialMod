package tk.melosh.tutorialmod.blocks;
...
import tk.melosh.tutorialmod.item.ModItemGrouping;
import tk.melosh.tutorialmod.item.ModItems;
...
public class ModBlocks {
    ...
    private static <T extends Block> void registerBlockItem(String name, RegistryObject<T> block) {
        ModItems.ITEMS.register(name, () -> new BlockItem(block.get(),
                new Item.Properties().group(ModItemGrouping.ITEM_GROUP)));
    }
